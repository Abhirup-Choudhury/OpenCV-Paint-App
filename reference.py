...
# paint brush icon
brush = cv2.imread('brush.png', 3)
brush = cv2.resize(brush, (20, 20))
eraser = cv2.imread('eraser.png', 3)  # eraser icon
eraser = cv2.resize(eraser, (20, 20))
# to reduce the brush or eraser size
plus = cv2.imread('plus.png', 3)
plus = cv2.resize(plus, (20, 20))
# to increase the brush or eraser size
minus = cv2.imread('minus.png', 3)
minus = cv2.resize(minus, (20, 20))
